...
Similarly, when we grouped participants into "Republican" (*n* = `r n.republican`) and "Democrat" (*n* = `r n.democrat`) categories, we did find a main effect of political party such that participants who identified as Democrat selected significantly more green products (_M_ = `r mean.dem`, _SD_ = `r sd.dem`) than participants who identified as Republican (_M_ = `r mean.rep`, _SD_ = `r sd.rep`), `r apa_anova2$full$RorD`. There was, however, no interaction between political party and condition, `r apa_anova2$full$RorD_new_condition`.
